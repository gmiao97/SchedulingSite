...
class UserViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        mail.send_mail(
            ...
            '①会員登録14日後に月会費の自動決済が始まります\n'
            '登録いただいてから14日間は、無料トライアル期間です。\n'
            '14日後は、月会費が自動決済されますので、ご了承ください。\n'
            '紹介コードなしでご登録された方は、月会費と一緒に体験後の入会費US$50もご請求させていただきます。\n'
            ...
            'また、最新のメルマガは\n'
            '[https://docs.google.com/document/d/1fM2oD8FjPZtYxwIOfN5hk_wKvEuII4TW2P8YoL516Js/edit]からご確認ください！\n\n'
