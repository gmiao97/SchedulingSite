...
'★会員向けフリーレッスンをすぐに体験する！',
'※会員登録時に紹介コードを入力すると、体験後の入会費$50が20%OFFになります。',
'.',
'★会員向けフリーレッスンの特徴',
'・クラスは週５日ご用意してます',
...
'（会員登録後14日は無料トライアルです。継続の場合は14日後に決済が始まります。）',
'.',
'また、会員向けフリーレッスンに加えて個別（グループ）レッスンもご用意しております。',
'ご希望であれば個別レッスンの体験も1回までしていただけますのでお気軽にお申し付けください。',
'info@mercy-education.com　',
'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~',
'【会員登録手順】',
'.',
...
'（お子様1人一つずつ、アカウント登録ください。ユーザーIDとパスワードは自由に設定できます。半角英数8文字以上）',
'.',
'☆★会員登録後14日は無料トライアルです。継続の場合は14日後に決済が始まります。★☆'];